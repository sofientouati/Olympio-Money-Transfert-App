...
public class SimulateurActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appbar = (AppBarLayout) findViewById(R.id.simulateursAppBar);
        drawerLayout = (DrawerLayout) findViewById(R.id.simulateursDrawerLayout);
        navigationView = (NavigationView) findViewById(R.id.simulateur_nav_view);
        navigationView.setNavigationItemSelectedListener(this);
        View view = navigationView.getHeaderView(0);
        navigationView.setCheckedItem(R.id.simulateurs);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.home:
                ActivityCompat.startActivity(SimulateurActivity.this, new Intent(SimulateurActivity.this, HomeActivity.class), null);
                break;
            case R.id.bourse:
...
//                drawerayout.closeDrawer(GravityCompat.START);
            ...
            case R.id.settings:
                ...
                break;
            case R.id.apropos:
                startActivity(new Intent(SimulateurActivity.this, AboutActivity.class));
                break;
            case R.id.logout: {

                editor.clear();
                editor.apply();
                ActivityCompat.startActivity(SimulateurActivity.this, new Intent(SimulateurActivity.this, LoginActivity.class), null);
                finish();
                break;
            }
        }
